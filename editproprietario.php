...
if (!$proprietario) {
    $_SESSION['mensagem'] = 'Proprietário não encontrado.';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $resultado = $proprietarioRepo->atualizar($id, $_POST);
    
    if ($resultado) {
        $_SESSION['mensagem'] = 'Proprietário atualizado com sucesso!';
        $_SESSION['tipo_mensagem'] = 'success';
        header('Location: proprietario.php');
        exit;
    } else {
        $_SESSION['mensagem'] = 'Erro ao atualizar proprietário.';
        $_SESSION['tipo_mensagem'] = 'error';
    }
}
?>
...
<html>
<head>
    <title>Editar Proprietário - SubRider</title>
    <meta charset="utf-8" />
    ...
    <div id="page-wrapper">
        ...
        <section id="content" class="main">
            <div class="container">
                ...
                <form method="post" action="editproprietario.php?id=<?php echo $id; ?>" 
                      onsubmit="return validarFormulario()">
                    <div class="row gtr-uniform">
                        <div class="col-6">
                            <label for="nome">Nome Completo *</label>
                            <input type="text" name="nome" id="nome" required 
                                   value="<?php echo htmlspecialchars($proprietario['nome']); ?>" />
                        </div>
                        <div class="col-6">
                            <label for="cpf">CPF *</label>
                            <input type="text" name="cpf" id="cpf" required 
                                   value="<?php echo htmlspecialchars(formatarCPF($proprietario['cpf'])); ?>" 
                                   maxlength="14" />
                        </div>
                        <div class="col-6">
                            <label for="telefone">Telefone *</label>
                            <input type="text" name="telefone" id="telefone" required 
                                   value="<?php echo htmlspecialchars(formatarTelefone($proprietario['telefone'])); ?>" 
                                   maxlength="15" />
                        </div>
                        <div class="col-6">
                            <label for="email">E-mail</label>
                            <input type="email" name="email" id="email" 
                                   value="<?php echo htmlspecialchars($proprietario['email']); ?>" />
                        </div>
                        <div class="col-12">
                            <label for="endereco">Endereço *</label>
                            <input type="text" name="endereco" id="endereco" required 
                                   value="<?php echo htmlspecialchars($proprietario['endereco']); ?>" />
                        </div>
                        <div class="col-6">
                            <label for="cidade">Cidade *</label>
                            <input type="text" name="cidade" id="cidade" required 
                                   value="<?php echo htmlspecialchars($proprietario['cidade']); ?>" />
                        </div>
                        <div class="col-3">
                            ...
                            <select name="estado" id="estado" required>
                                ...
                                foreach ($estados as $estado) {
                                    $selected = $estado === $proprietario['estado'] ? 'selected' : '';
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" name="cep" id="cep" required 
                                   value="<?php echo htmlspecialchars(formatarCEP($proprietario['cep'])); ?>" 
                                   maxlength="9" />
                        </div>
                        <div class="col-12">
                            <ul class="actions">
