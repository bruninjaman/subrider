...
<body class="is-prload landing">
    <div id="page-wrapper">
        <!-- content -->
        <?php 
        include("./pages/tabelaServicosEdit/header/header.php");
        include("./pages/tabelaServicosEdit/sections/editservicos.php");
        include("./pages/tabelaServicosEdit/footer/footer.php");
        ?>
    </div>
