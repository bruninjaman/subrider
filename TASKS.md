...
## Substituição de includes por config.php

### ✅ Páginas Concluídas
- [x] tabelaServicosAdd.php
- [x] tabelaServicos.php
- [x] tabela_ordemservicos.php
- [x] tabelaPecasAdd.php
- [x] tabelaPecasEdit.php
- [x] tabelaOrdensEdit.php
- [x] tabelaOrdensAdd.php
- [x] relatorio.php
- [x] ordem_edit_item.php
- [x] ordem_add_item.php
- [x] medicoes.php
- [x] ordemservico.php
- [x] addmotos.php
- [x] editmotos.php
- [x] scripts/log-in.php
- [x] scripts/ordem-delete/ordem-delete.php
...
- [x] scripts/tabelaMotos/edit-moto.php
- [x] scripts/tabelaServicosEdit/edit-servico.php
- [x] scripts/tabelaMotos/delete-moto.php
- [x] scripts/tabelaMotos/add-moto.php
...
- [x] scripts/tabelaOrdensAdd/open-service.php
- [x] scripts/ordem_edit_item/ordem_edit_item.php
- [x] scripts/ordem_add_item/ordem_add_item.php
- [x] scripts/ordemservico/register_medicoes.php
- [x] pdf/download.php
