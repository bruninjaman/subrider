...
require_once __DIR__ . '/../../src/Controllers/ProprietarioController.php';

use App\Controllers\ProprietarioController;

$controller = new ProprietarioController();

if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $erros = $controller->validarDados($_POST);
    
    if (empty($erros)) {
        if ($controller->criar($_POST)) {
    ...
    <div id="page-wrapper">
        ...
        <section id="content" class="main">
            <div class="container">
                ...
                <form method="post" action="/pages/proprietario/add.php" onsubmit="return validarFormulario()">
