<div class="form-container">
    ...
    <form id="cabecoteForm" class="needs-validation custom-form" novalidate>
        <div class="container px-4">
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-4">
                    <div class="floating-input">
                        <input type="text" name="num_cilindros" class="form-control" id="num_cilindros"
                            data-type="decimal" min="1" max="16" placeholder=" ">
                ...
                <div class="col-md-4">
                    <div class="floating-input">
                        <input type="text" name="num_val_adm" id="num_val_adm" class="form-control" data-type="decimal"
                ...
                <div class="col-md-4">
                    <div class="floating-input">
                        <input type="text" name="num_val_esc" id="num_val_esc" class="form-control" data-type="decimal"
                            min="1" max="8" placeholder=" ">
            ...
            <div class="section-group mb-5" id="engine_config_section">
            ...
            <div id="ohc_fields" class="animated-section" style="display: none;">
                <div class="floating-input">
                    <input type="text" step="0.01" class="form-control" name="came_diam_min" id="came_diam_min"
            ...
            <div id="dohc_fields" class="animated-section" style="display: none;">
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="floating-input">
                            <input type="text" step="0.01" class="form-control" name="cames_adm_diam_min"
                                id="cames_adm_diam_min" data-type="decimal" placeholder=" ">
                    ...
                    <div class="col-md-6">
                        <div class="floating-input">
                            <input type="text" step="0.01" class="form-control" name="cames_esc_diam_min"
                                id="cames_esc_diam_min" data-type="decimal" placeholder=" ">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="val_adm_limite_min"
                                        data-type="decimal" placeholder=" ">
                                    <label>Mínimo</label>
                                    <div class="focus-border"></div>
                                </div>
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="val_adm_limite_max"
                                        data-type="decimal" placeholder=" ">
                                    <label>Máximo</label>
                                    <div class="focus-border"></div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="val_esc_limite_min"
                                        data-type="decimal" placeholder=" ">
                                    <label>Mínimo</label>
                                    <div class="focus-border"></div>
                                </div>
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="val_esc_limite_max"
                                        data-type="decimal" placeholder=" ">
                                    <label>Máximo</label>
                                    <div class="focus-border"></div>
                                </div>
                ...
                <div class="row g-4 mt-4">
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="came_adm_altura_min"
                                        data-type="decimal" placeholder=" ">
                    ...
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="came_esc_altura_min"
                                        data-type="decimal" placeholder=" ">
                                    <label>Altura Mínima</label>
                                    <div class="focus-border"></div>
                                </div>
                ...
                <div class="row g-4 mt-4">
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="eixo_cames_lim_empen"
                                        data-type="decimal" placeholder=" ">
                                    <label>Limite</label>
                                    <div class="focus-border"></div>
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="measure-group">
                            ...
                            <div class="measure-inputs">
                                <div class="floating-input">
                                    <input type="text" step="0.01" class="form-control" name="folga_eixo_mancal"
                                        data-type="decimal" placeholder=" ">
                                    <label>Folga</label>
                                    <div class="focus-border"></div>
                                </div>
            ...
            <div class="compression-section mt-5">
                <div class="measure-group">
                    ...
                    <div class="measure-inputs">
                        <div class="floating-input">
                            <input type="text" class="form-control" name="compressao_min" data-type="decimal"
                                placeholder=" ">
                            <label>Mínimo</label>
                            <div class="focus-border"></div>
                        </div>
                        <div class="floating-input">
                            <input type="text" class="form-control" name="compressao_max" data-type="decimal"
                                placeholder=" ">
                            <label>Máximo</label>
                            <div class="focus-border"></div>
                        </div>
