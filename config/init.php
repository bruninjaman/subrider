...
if (basename($_SERVER['SCRIPT_FILENAME']) === 'index.php' && 
    ...
    // Log da tentativa de acesso direto
    error_log("Tentativa de acesso direto detectada: " . $_SERVER['REQUEST_URI']);
...
// require_once __DIR__ . '/../scripts/functions.php';  // Arquivo não existe, comentado temporariamente
