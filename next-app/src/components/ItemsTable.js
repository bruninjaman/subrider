    ...
    return (
        <div className="table-wrapper" style={{ background: 'rgba(255,255,255,0.02)', padding: '0', overflow: 'hidden' }}>
            ...
            <div className="table-section" style={{ marginBottom: '40px' }}>
                <div className="items-table-header" style={{ background: 'rgba(255,255,255,0.05)', padding: '15px 25px', color: '#e44c65', fontWeight: '600', fontSize: '1.2rem', display: 'flex', justifyContent: 'space-between' }}>
                    <span>SERVIÇOS</span>
            ...
            <div className="table-section" style={{ marginBottom: '40px' }}>
                <div className="items-table-header" style={{ background: 'rgba(255,255,255,0.05)', padding: '15px 25px', color: '#e44c65', fontWeight: '600', fontSize: '1.2rem', display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ opacity: 0.6, fontWeight: '400', fontSize: '0.9rem' }}>{adiantamentos.length} itens</span>
                </div>
                <table className="measurements-table">
                    <thead>
                        <tr style={{ background: 'rgba(0,0,0,0.3)' }}>
                    ...
                    <tbody>
                        {adiantamentos.length > 0 ? adiantamentos.map(item => (
                            ...
                            <tr><td colSpan="5" style={{ textAlign: 'center', padding: '30px', opacity: 0.5 }}>Nenhum adiantamento registrado</td></tr>
                        )}
                    </tbody>
                    <tfoot>
                        <tr style={{ background: 'rgba(255,255,255,0.02)' }}>
                            <td colSpan="3" style={{ textAlign: 'right', padding: '15px 25px', fontWeight: '500' }}>Total Adiantamentos:</td>
                            <td style={{ textAlign: 'center', fontWeight: '700', color: '#e44c65' }}>{formatCurrency(totalAdiantamentos)}</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
